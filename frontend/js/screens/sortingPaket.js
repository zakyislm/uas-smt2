...
function renderSortingPaketScreen() {
    return `
    ${renderHeader('Sorting Paket', 'Urutkan paket berdasarkan biaya atau berat')}
    <div class="content screen-enter" id="sorting-content">
        <div class="card">
            <div class="card-header">
                <div>
                    <div class="card-title"><span class="material-icons-outlined">sort</span> Sorting Paket</div>
                    <div class="card-subtitle">Menggunakan std::sort (Introsort O(n log n))</div>
                </div>
            </div>
            <div class="tabs" id="sort-tabs">
                <div class="tab active" onclick="doSort('biaya','asc',this)"><span class="material-icons-outlined">payments</span> Biaya ↑</div>
                <div class="tab" onclick="doSort('biaya','desc',this)"><span class="material-icons-outlined">payments</span> Biaya ↓</div>
                <div class="tab" onclick="doSort('berat','asc',this)"><span class="material-icons-outlined">scale</span> Berat ↑</div>
                <div class="tab" onclick="doSort('berat','desc',this)"><span class="material-icons-outlined">scale</span> Berat ↓</div>
            </div>
            <div id="sort-results">
...
async function doSort(by, order, tabEl) {
    ...
    try {
        ...
        const label = by === 'biaya' ? 'Biaya' : 'Berat';
        ...
        ${renderTable(
            [
                ...
                { label: 'Berat', render: r => `<span style="font-weight:${by==='berat'?'700':'400'}">${r.berat} kg</span>` },
