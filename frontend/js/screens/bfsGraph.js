/**
 * Dokumentasi Halaman Graph BFS (bfsGraph.js)
 * 
 * File ini mengatur antarmuka dan logika pencarian jalur terpendek menggunakan algoritme Breadth-First Search (BFS).
 * Pengguna dapat memilih kota asal dan tujuan untuk melihat visualisasi animasi rute terbaik dengan jumlah transit minimal.
 */
...
async function initBfsGraph() {
    try {
        ...
        el.innerHTML = `
        <div class="card">
            <div class="card-title mb-md">Cari Jalur Terpendek (BFS)</div>
            <div class="graph-controls">
                <div class="form-group" style="min-width:200px">
                    <label class="form-label">KOTA ASAL</label>
                    <select class="form-select" id="bfs-from" onchange="runBFS(true)">
                ...
                <div class="form-group" style="min-width:200px">
                    ...
                    <select class="form-select" id="bfs-to" onchange="runBFS(true)">
...
async function runBFS(isAuto = false) {
    ...
    try {
        ...
        if (result.path && result.path.length > 1) {
            GraphRenderer.animatePath('bfs-canvas', cities, edges, result.path);
        } else {
        ...
        if (result.path && result.path.length > 0) {
            ...
            <div class="card" style="border-color:var(--status-success);background:rgba(74,222,128,0.03)">
                <div class="card-title" style="color:var(--status-success)">Jalur Ditemukan</div>
